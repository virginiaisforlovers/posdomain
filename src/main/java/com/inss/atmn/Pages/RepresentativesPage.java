...
public class RepresentativesPage extends BasePage {
  ...
  private List<WebElement> getDistrictWebElementsByState(String state, int columnNumber) {
  ...
  public void getRepresentativeNameByState(String state) {
    List<WebElement> listDistrict = getDistrictWebElementsByState(state, 2);
    for (int i = 0; i < listDistrict.size(); i++) {
      System.out.println(listDistrict.get(i).getText());
    }
  }
  ...
  public void getPartyByState(String state) {
    List<WebElement> listDistrict = getDistrictWebElementsByState(state, 3);
    for (int i = 0; i < listDistrict.size(); i++) {
      System.out.println(listDistrict.get(i).getText());
    }
  }
  ...
  public void getOfficerRoomByState(String state) {
    List<WebElement> listDistrict = getDistrictWebElementsByState(state, 4);
    for (int i = 0; i < listDistrict.size(); i++) {
      System.out.println(listDistrict.get(i).getText());
    }
  }
  ...
  public void getPhoneByState(String state) {
    List<WebElement> listDistrict = getDistrictWebElementsByState(state, 5);
    for (int i = 0; i < listDistrict.size(); i++) {
      System.out.println(listDistrict.get(i).getText());
    }
  }
  ...
  public void getCommitteeByState(String state) {
    List<WebElement> listDistrict = getDistrictWebElementsByState(state, 6);
    for (int i = 0; i < listDistrict.size(); i++) {
      System.out.println(listDistrict.get(i).getText());
    }
  }
